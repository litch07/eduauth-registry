...
import { Building2, Mail, Phone, MapPin, Globe, Users, Calendar, FileText, XCircle } from 'lucide-react';
      ...
      <div className="mx-auto max-w-4xl space-y-6 p-6">
        ...
        <div className="rounded-2xl bg-gradient-to-r from-primary to-primary-light p-6 text-white shadow-lg">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold">{profileData?.name || 'Institution'}</h2>
              <p className="text-sm text-blue-100">University Profile</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-900 dark:text-white">{profileData?.address || 'Not provided'}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl bg-white dark:bg-gray-800 p-6 shadow-sm ring-1 ring-slate-200 dark:ring-gray-700">
            <h3 className="mb-4 text-lg font-bold text-slate-900 dark:text-white">Institution Details</h3>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <FileText className="mt-0.5 h-5 w-5 text-primary" />
                <div>
                  <p className="text-xs font-semibold text-slate-600 dark:text-gray-300">Registration Number</p>
                  <p className="text-sm font-mono text-slate-900 dark:text-white">{profileData?.registrationNumber || 'Not provided'}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Calendar className="mt-0.5 h-5 w-5 text-primary" />
                <div>
                  <p className="text-xs font-semibold text-slate-600 dark:text-gray-300">Established Year</p>
                  <p className="text-sm text-slate-900 dark:text-white">{profileData?.establishedYear || 'Not provided'}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
          ...
          <div className="rounded-xl bg-white dark:bg-gray-800 p-6 shadow-sm ring-1 ring-slate-200 dark:ring-gray-700 md:col-span-2">
            <h3 className="mb-4 text-lg font-bold text-slate-900 dark:text-white">Authority Information</h3>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="flex items-start gap-3">
                <Users className="mt-0.5 h-5 w-5 text-primary" />
                <div>
                  <p className="text-xs font-semibold text-slate-600 dark:text-gray-300">Authority Name</p>
                  <p className="text-sm text-slate-900 dark:text-white">{profileData?.authorityName || 'Not provided'}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <FileText className="mt-0.5 h-5 w-5 text-primary" />
                <div>
                  <p className="text-xs font-semibold text-slate-600 dark:text-gray-300">Authority Title</p>
                  <p className="text-sm text-slate-900 dark:text-white">{profileData?.authorityTitle || 'Vice Chancellor'}</p>
                </div>
              </div>
            </div>
          </div>
