...
import { GraduationCap, Loader2, ArrowLeft, XCircle } from 'lucide-react';
...
const StudentRegister = () => {
  ...
  const validateForm = () => {
    if (!formData.firstName || !formData.lastName || !formData.dateOfBirth || !formData.nid || 
        !formData.fatherName || !formData.motherName || !formData.email || !formData.password || 
        !formData.confirmPassword || !formData.phone || !formData.presentAddress) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-white dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 px-4 py-10 text-slate-900 dark:text-white">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-slate-600 dark:text-gray-300">Create your student account</p>
        </div>
        ...
        <div className="rounded-2xl bg-white dark:bg-gray-800 p-6 shadow-xl ring-1 ring-slate-200 dark:ring-gray-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-slate-900 dark:text-white uppercase tracking-wide">Personal Information</h3>
