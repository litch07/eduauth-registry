...
CREATE TABLE verification_logs (
  ...
  CONSTRAINT fk_verification_logs_certificate FOREIGN KEY (certificate_id)   REFERENCES certificates(id) ON DELETE SET NULL,
  CONSTRAINT fk_verification_logs_verifier    FOREIGN KEY (verifier_user_id) REFERENCES users(id)        ON DELETE SET NULL
);
...
CREATE TABLE withdrawal_requests (
  ...
  CONSTRAINT fk_withdrawal_reviewed   FOREIGN KEY (reviewed_by)   REFERENCES users(id)       ON DELETE SET NULL
);
